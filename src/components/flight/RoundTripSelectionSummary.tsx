...
interface RoundTripSelectionSummaryProps {
...
const RoundTripSelectionSummary: React.FC<RoundTripSelectionSummaryProps> = ({
  outbound,
  inbound,
  onEditOutbound,
  onEditInbound,
...
export default RoundTripSelectionSummary;
